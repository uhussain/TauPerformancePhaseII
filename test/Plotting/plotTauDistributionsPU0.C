...
void plotTauDistributionsPU0(){   
  TString fileName = "/data/uhussain/TwoTausEff_July26_hadd/Ztt_pre4_miniAOD_TwoTaus_pu0.root";
  //TString fileName = "/data/uhussain/TwoTausEff_Aug24_hadd/RelValZTT_MiniAOD_PU0.root"; 
  TString fileName1 = "/data/uhussain/TwoTausEff_Aug29_hadd/RelValZTT_MiniAOD_PU0.root"; 
  ...
  TString outFileName = "tauMass-eta3.0-pu0_900pre4_ZTT";
  //TString outFileName = "tauPtRes-eta4.0-puall_QCD";

  TString legLabel = "#tau_{h} from Z #rightarrow #tau #tau (RelVal) 0 PU"; 
 ...
 // }
  ...
  leg->AddEntry(PU0_afterfix,"9_0_0_pre4","PL"); 
