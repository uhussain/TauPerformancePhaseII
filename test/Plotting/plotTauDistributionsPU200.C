...
void plotTauDistributionsPU200(){   
  //TString fileName = "/data/uhussain/TwoTausEff_July26_hadd/Ztt_pre4_miniAOD_TwoTaus_pu140.root";
  TString fileName = "/data/uhussain/TwoTausEff_Aug24_hadd/RelValZTT_MiniAOD_PU200.root"; 
  TString fileName1 = "/data/uhussain/TwoTausEff_Aug29_hadd/RelValZTT_MiniAOD_PU200.root"; 
  //TString fileName2 = "/data/uhussain/TwoTausEff_Aug24_hadd/RelValZTT_MiniAOD_PU200.root"; 
  //TString fileName3 = "/data/uhussain/TwoTausEff_July19_hadd/RelValTTbar_miniAOD_3000.root"; 
  //TString fileName = "/data/uhussain/TwoTausEff_Aug24_hadd/QCD_Flat_MiniAOD_PU0.root";  
  //TString fileName1 = "/data/uhussain/TwoTausEff_Aug24_hadd/QCD_Flat_MiniAOD_PU140.root"; 
  //TString fileName2 = "/data/uhussain/TwoTausEff_Aug24_hadd/QCD_Flat_MiniAOD_PU200.root"; 
  ...
  TString basic = "abs(tauEta)>0 && abs(tauEta)<3.0 && taupfTausDiscriminationByDecayModeFinding==1";
  ...
  TString outFileName = "tauMass-eta3.0-pu200_930pre3_ZTT";
  //TString outFileName = "tauPtRes-eta4.0-puall_QCD";

  TString legLabel = "#tau_{h} from Z #rightarrow #tau #tau (RelVal) 200 PU"; 
 ...
 // }
  ...
  leg->AddEntry(PU0_afterfix,"9_3_0_pre3","PL"); 
  leg->AddEntry(PU140_afterfix,"9_3_0_pre4","PL");
