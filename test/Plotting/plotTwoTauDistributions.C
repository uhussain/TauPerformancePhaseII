...
void plotTwoTauDistributions(){ 
  ...
  TString outFileName = "PUcorrPtSum-eta2.3-puall_Real";
  setTDRStyle();
...
//  TFile *tauFile2    = new TFile(fileName);
//
...
//           }
  ...
  TString legLabel = "Genuine #tau_{h} (Z #rightarrow #tau #tau)";
  ...
  leg->AddEntry(PU0_beforefix,"Ztt 900_pre4(PU0)-BeforeFix");
  leg->AddEntry(PU0_afterfix,"Ztt 900_pre4 (PU0)-AfterFix"); 
  leg->AddEntry(PU200_beforefix,"Ztt 900_pre4 (PU140)-BeforeFix"); 
  leg->AddEntry(PU200_afterfix,"Ztt 900_pre4 (PU140)-AfterFix");
  leg->Draw();
