...
void plotTauDistributionsPU140(){   
  //TString fileName = "/data/uhussain/TwoTausEff_July26_hadd/Ztt_pre4_miniAOD_TwoTaus_pu140.root";
  TString fileName = "/data/uhussain/TwoTausEff_Aug24_hadd/RelValZTT_MiniAOD_PU140.root"; 
  ...
  TString outFileName = "tauMass-eta3.0-pu140_930pre3_ZTT";
  //TString outFileName = "tauPtRes-eta4.0-puall_QCD";

  TString legLabel = "#tau_{h} from Z #rightarrow #tau #tau (RelVal) 140 PU"; 
